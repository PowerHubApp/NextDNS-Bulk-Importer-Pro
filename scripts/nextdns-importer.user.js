...
// @author       PowerHub
// @icon         data:image/png;base64,
...
(function() {
    ...
    const styles = `
        ...
        .imp-row button { flex: 1; height: 38px; border-radius: 7px; font-size: 14px; font-weight: 500; cursor: pointer; box-sizing: border-box; font-family: inherit; border: 1px solid transparent; user-select: none; }
        #imp-start { background: #0070f3; color: #fff; }
        #imp-start:hover { background: #1a80f5; }
        #imp-close { transition: all 0.15s ease; }
        ...
        .bl-checkbox-list { max-height: 120px; overflow-y: auto; border: 1px solid transparent; padding: 10px; border-radius: 7px; margin-bottom: 12px; display: none; grid-template-columns: 1fr; gap: 4px; }
        ...
        @media (max-width: 480px) {
            ...
            #ndns-imp-pnl { bottom: 68px; right: 16px; left: 16px; width: auto; max-width: none; padding: 22px 14px 14px 14px; max-height: calc(100vh - 100px); }
        ...
        @media (max-height: 600px) {
            #ndns-imp-pnl:not(.mac-fullscreen) { top: 20px; bottom: auto; max-height: calc(100vh - 40px); }
    ...
    document.body.insertAdjacentHTML('beforeend', `
        <div id="ndns-imp-pnl">
            ...
            <div class="lbl-row-container">
                <span class="imp-fld-lbl">Operation Mode</span>
            </div>
            <select id="imp-action">
                <option value="add" selected>Bulk Add (+)</option>
                <option value="remove">Bulk Remove (-)</option>
            </select>

            <div class="lbl-row-container">
                <span class="imp-fld-lbl">Import Type</span>
            </div>
            <select id="imp-type">
                <option value="tld">TLDs</option>
                <option value="blocklists">Block Lists</option>
                <option value="denylist" selected>Deny Lists</option>
                <option value="allowlist">Allow Lists</option>
                <option value="rewrites">Rewrites</option>
            </select>
            ...
            <div class="imp-row">
                <button id="imp-start">Bulk Add</button>
                <button id="imp-close">Cancel</button>
            </div>
    ...
    const modeActionSel = document.getElementById("imp-action");
    ...
    const processStartBtn = document.getElementById("imp-start");
    ...
    function uiToggle() {
        ...
        pWrap.style.display = isTld && modeActionSel.value !== "remove" ? "block" : "none";
    ...
    typeSel.addEventListener("change", uiToggle);
    modeActionSel.addEventListener("change", uiToggle);
    ...
    async function sendRequest(url, method, payload) {
        ...
        if (res.status === 429) {
            ...
            let retryAfterHeader = parseInt(res.headers.get("Retry-After"), 15);
            let totalDelaySeconds = !isNaN(retryAfterHeader) && retryAfterHeader > 15 ? retryAfterHeader : 15;
    ...
    processStartBtn.addEventListener("click", async (e) => {
        e.preventDefault();
        const profId = profSel.value;
        const type = typeSel.value;
        const preset = presetSel.value;
        const opMode = modeActionSel.value; 
        const isRemoveMode = opMode === "remove";
        const isBlocklists = type === "blocklists";

        if (!profId || isImporting) return;
